...
<%@ page import="universidad.Usuario" %>
<!DOCTYPE html>
<html>
	<head>
			...
			<ol class="property-list usuario">
				...
				<li class="fieldcontain">
					<span id="role-label" class="property-label"><g:message code="usuario.role.label" default="Role" /></span>
						...
						<span class="property-value" aria-labelledby="role-label"><g:link controller="role" action="show" id="${usuarioInstance?.role?.id}">${usuarioInstance?.role?.encodeAsHTML()}</g:link></span>
