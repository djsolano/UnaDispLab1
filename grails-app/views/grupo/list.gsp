			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="horario" title="${message(code: 'grupo.horario.label', default: 'Horario')}" />
					
						<g:sortableColumn property="numero" title="${message(code: 'grupo.numero.label', default: 'Numero')}" />
				...
				<g:each in="${grupoInstanceList}" status="i" var="grupoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: grupoInstance, field: "horario")}</td>
					
						<td>${fieldValue(bean: grupoInstance, field: "numero")}</td>
					
						<td>${fieldValue(bean: grupoInstance, field: "profesor")}</td>
